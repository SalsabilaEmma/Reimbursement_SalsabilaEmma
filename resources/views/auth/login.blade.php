...
<html lang="en">
  <head>
    ...
    <title>Login - Reimbursement Salsabila Emma</title>
    <!-- Google font-->
  ...
  <body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="col-xl-7"><img class="bg-img-cover bg-center" src="{{ url('cuba') }}/assets/images/logo.png" alt="looginpage"></div>
        <div class="col-xl-5 p-0">
          <div class="login-card">
            <div>
              <div><a class="logo text-start" href="{{ route('login') }}">
                {{-- <img class="img-fluid for-light" src="{{ url('cuba') }}/assets/images/favicon.png" alt="looginpage"><img class="img-fluid for-dark" src="{{ url('cuba') }}/assets/images/logo/logo_dark.png" alt="looginpage"> --}}
                </a></div>
