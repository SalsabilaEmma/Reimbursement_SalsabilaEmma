                    ...
                    <div class="card profile-greeting">
                        <div class="card-body pb-0">
                            ...
                            <div class="cartoon"><img class="img-fluid"
                                    src="{{ url('public/cuba') }}/assets/images/dashboard/cartoon.png" alt=""></div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body p-0">
                            <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                                    src="{{ url('public/cuba') }}/assets/images/dashboard/update/1.jpg" alt="">
                                <div class="media-body">
                            ...
                            <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                                    src="{{ url('public/cuba') }}/assets/images/dashboard/update/2.jpg" alt="">
                                <div class="media-body">
                            ...
                            <div class="news-update media"><img class="img-fluid me-3 b-r-10"
                                    src="{{ url('public/cuba') }}/assets/images/dashboard/update/3.jpg" alt="">
                                <div class="media-body">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td><img class="img-fluid img-40 rounded-circle mb-3"
                                                            src="{{ url('public/cuba') }}/assets/images/appointment/app-ent.jpg"
                                ...
                                <div class="media-body">
                                    <div class="d-flex mb-3">
                                        <div class="inner-img"><img class="img-fluid"
                                                src="{{ url('public/cuba') }}/assets/images/notification/1.jpg"
                                                alt="Product-1"></div>
                                        <div class="inner-img"><img class="img-fluid"
                                                src="{{ url('public/cuba') }}/assets/images/notification/2.jpg"
                                                alt="Product-2"></div>
                                ...
                                <div class="media left-side-chat">
                                    <div class="media-body d-flex">
                                        <div class="img-profile"> <img class="img-fluid"
                                                src="{{ url('public/cuba') }}/assets/images/user.jpg" alt="Profile"></div>
                                        <div class="main-chat">
